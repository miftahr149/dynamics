                    ...
                    <div class="main_header d-flex justify-content-between align-items-center">
                        ...
                        <div class="header_right_sidebar d-flex align-items-center">
                            <div class="sing_up_btn">
                                <a class="btn btn-link magic-hover magic-hover__square" href="<?php echo BASE_URL . "competition" ?>">JOIN NOW <img width="15" height="15" src="assets/img/icon/arrrow-icon2.webp" alt=""> </a>
                            </div>
