    ...
    <div class="page_wrapper">
        ...
        <section class="hero_banner_section d-flex align-items-center mb-130" data-bgimg="<?= BASE_URL ?>assets/img/bg/hero-bg1.webp">
            ...
            <div class="hero_position_img">
                <img width="926" height="772" src="<?= BASE_URL ?>assets/img/bg/hero-position-img.webp" alt="">
            </div>
        </section>
        <!--slider area end-->
                ...
                <div class="section_title text-center wow fadeInUp mb-60" data-wow-delay="0.1s" data-wow-duration="1.1s">
                    ...
                    <div class="gaming_world_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single_gaming_world wow fadeInUp" data-bgimg="<?= BASE_URL ?>assets/img/others/gaming-world-bg2.webp" data-wow-delay="0.2s" data-wow-duration="1.2s">
                                <div class="gaming_world_thumb">
                                    <img width="156" height="157" src="<?= BASE_URL ?>assets/img/others/gaming-world2.webp" alt="">
                                </div>
                                <div class="gaming_world_text">
                                    <h3>Game News</h3>
                                    <p>When unknown printer took
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single_gaming_world wow fadeInUp" data-bgimg="<?= BASE_URL ?>assets/img/others/gaming-world-bg3.webp" data-wow-delay="0.3s" data-wow-duration="1.3s">
                                <div class="gaming_world_thumb">
                                    <img width="151" height="156" src="<?= BASE_URL ?>assets/img/others/gaming-world3.webp" alt="">
                                </div>
                                <div class="gaming_world_text">
                    ...
                    <div class="col-12">
                        <div class="gaming_video_inner slick_navigation slick__activation" data-slick='{
                            ...
                            <div class="gaming_video_thumb">
                                <img width="1170" height="540" src="<?= BASE_URL ?>assets/img/bg/gaming-bg1.webp" alt="">
